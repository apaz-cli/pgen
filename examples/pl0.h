...
struct pl0_astnode_t {
  ...
  union {
    program_astnode_t program;
    block_astnode_t block;
    statement_astnode_t statement;
    condition_astnode_t condition;
    expression_astnode_t expression;
    term_astnode_t term;
    factor_astnode_t factor;
  };
};
